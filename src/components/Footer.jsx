...
export default function Footer() {
  return (
    <footer className="border-t border-slate-200 dark:border-slate-800 pt-16 pb-8 px-6 bg-background-light dark:bg-background-dark">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-8">
          <div className="col-span-1 md:col-span-1">
            <div className="mb-6">
              <Link to="/" className="inline-block">
                <img src={logo} alt="Infinity Glass Logo" className="h-14 w-auto" />
              </Link>
            </div>
            <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
              Leading provider of premium glass and interior fit-out solutions for modern spaces.
            </p>
          </div>
          <div>
            <h5 className="font-bold mb-6">Services</h5>
            <ul className="space-y-3 text-sm text-slate-500 dark:text-slate-400">
              <li><Link className="hover:text-primary transition-colors" to="/services">Glass Partitions & Railings</Link></li>
              <li><Link className="hover:text-primary transition-colors" to="/services">ACP, HPL & Shera Cladding</Link></li>
              <li><Link className="hover:text-primary transition-colors" to="/services">Spider Glazing</Link></li>
              <li><Link className="hover:text-primary transition-colors" to="/services">Glass & Clay Canopies</Link></li>
              <li><Link className="hover:text-primary transition-colors" to="/services">All Types of Wood Works</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a className="size-10 rounded-full border border-slate-200 dark:border-slate-800 flex items-center justify-center hover:bg-primary hover:text-white transition-all" href="mailto:infinityglassinteriors@gmail.com">
        ...
        <div className="pt-8 border-t border-slate-200 dark:border-slate-800 text-center text-sm text-slate-500 dark:text-slate-400">
          <p>© 2026 Infinity Glass & Interior Works. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
