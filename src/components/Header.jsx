        ...
        <div className="flex flex-col items-center justify-center h-full gap-8 px-6 pt-20 pb-10">
          ...
          <div className="mt-auto text-center flex flex-col gap-4">
            ...
            <div className="flex gap-4 justify-center mt-4">
              <a className="size-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center hover:bg-primary hover:text-white transition-all text-slate-600 dark:text-slate-400" href="https://instagram.com/infinityglassinteriorworks" target="_blank" rel="noreferrer">
              ...
              <a className="size-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center hover:bg-primary hover:text-white transition-all text-slate-600 dark:text-slate-400" href="https://facebook.com/infinityglassandinteriorworks" target="_blank" rel="noreferrer">
                <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
